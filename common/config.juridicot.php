...
**	arquivo:	config.php
**
**	Variaveis do Sistema da Gestão de processos trabalhista
**
************************************************************************************************************
	**
	**	author:	James Reig
...
$mysql_db_assessoria = "trabalhista";		//mysql database name
...
$mysql_anexo_table            = $mysql_db_assessoria.".anexos";			//mysql tabela de anexos
$mysql_empresa_table          = $mysql_db_assessoria.".empresa";			//mysql tabela de empresa
$mysql_classe_table           = $mysql_db_assessoria.".classe";			//mysql tabela de classe
$mysql_comarca_table           = $mysql_db_assessoria.".comarca";			//mysql tabela de comarca
$mysql_status_table           = $mysql_db_assessoria.".status";			//mysql tabela de status
