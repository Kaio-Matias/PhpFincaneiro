...
$mysql_pwd = "#x035604#V@le21";			//mysql password
...
$mysql_ip_autorizado_table	= "ip_autorizado";				//mysql tabela de IPs autorizados
$mysql_acessoremoto_table	= "acessoremoto";				//mysql tabela de usuários remotos
...
$mysql_votes_table       	= "votes";
$mysql_perguntas_table    	= "perguntas";
