...
/*		for($a=1;$a<21;$a++) {
			...
			execsql("insert into $mysql_enderecos_table values ('T".$t."A')");
			execsql("insert into $mysql_enderecos_table values ('T".$t."B')");
			execsql("insert into $mysql_enderecos_table values ('T".$t."C')");
			execsql("insert into $mysql_enderecos_table values ('T".$t."D')");
			execsql("insert into $mysql_enderecos_table values ('T".$t."E')");		
		}*/
...
$mysql_db_producao = "producao";		//mysql Nome do Banco de dados
