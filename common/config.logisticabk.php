...
$mysql_resumo_table				=	$mysql_database_logistica."devresumo";		// Nome da tabela de Devolução Resumo
...
$mysql_metafrete_table			=	$mysql_database_logistica."metafrete";		// Nome da tabela de Hierarquia
...
$semfrete = "0000200030";
$classificacao = array ('DIST' => 'Distribuição', 'VEDI' => 'Venda Direta', 'TRAN' => 'Transferência');
?>