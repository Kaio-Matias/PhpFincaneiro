...
function createSelectComarca()
{
	global $mysql_comarca_table, $info;
  	$sql = "select codigo comarca, descricao from $mysql_comarca_table order by codigo asc";
	$result = execsql($sql);
				...
				<TABLE cellSpacing=1 cellPadding=2 width=100% border=0>
					...
					<TD class=tdcabecalho1 colspan=100% align=left><B>Movimentar Processo				</td>
   					...
   					<tr>
							...
							<td class=back><input type="text" name="datamov" size="11" maxlength="10" onFocus="javascript:vDateType=\'3\'" onKeyUp="DateFormat(this,this.value,event,false,\'3\')" onBlur="DateFormat(this,this.value,event,true,\'3\')" value=""></tr><tr>
