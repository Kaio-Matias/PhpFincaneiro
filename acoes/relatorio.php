...
//				$matriz = explode("\\\"",substr($$row[0],0,-2));
				...
				$where .= " and a.".$row[3]." in (".substr($in,0,-1).")";
				$inforelat[$row[3]] = str_replace("'","",str_replace("',",", ",substr($in,0,-1)));
				$inforelatw["w".$row[3]] = " and a.".$row[3]." in (".substr($in,0,-1).")";
			}
...
// James 18/05/2008 fim
			...
			if ($matriz[1] != "--") {
				$where .= " and a.".$row[3]." >= '".$matriz[0]."' and a.".$row[3]." <= '".$matriz[1]."'";
				$inforelatw["w".$row[3]] = " and a.".$row[3]." >= '".$matriz[0]."' and a.".$row[3]." <= '".$matriz[1]."'";
				$inforelat[$row[3]] = $matriz[0]." até ".$matriz[1];
                $inforelat[$row[3]] = $cab1." até ".$cab2;
			} else  {
				$where .= " and a.".$row[3]." = '".$matriz[0]."'";
//				$inforelat[$row[3]] = $matriz[0];
				$inforelat[$row[3]] = $cab2;
				$inforelatw["w".$row[3]] = " and a.".$row[3]." = '".$matriz[0]."'";
...
echo "<br><br><br><center><font size=1>$nomeprestconta<br>";
