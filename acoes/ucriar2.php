...
**	file:	ucriar2.php
**
**		Adicinar Patronos / Procuradores - Controle Jurídico
**	
**
***************************************************************************************************
	**
...
var srcList = self.opener.window.document.forms[0].elements['parentList2[]'];
...
if(isset($adicionar)){
	...
	if($nome == ''){
		...
		if($error != 1){ 
			 	$sql = "insert into $mysql_pessoas_table values('','$nome','$endereco','$bairro','$cidade','$UF','$cep','$telcomddd','$telcom','$telresddd','$telres','$telcelddd','$telcel','$faxddd','$fax','$email','$cpfcgc','$rgie','$tipopessoa','$patrono')";
...
echo '<form action="ucriar2.php" method=post>';
...
echo '
	...
	<TR> 
				<TD colspan=100% align=middle><B>Cadastrar Patrono / Procurador</B><br><br></TD>
				</TR>		
	<TR> 
			<TD class="tdfundo"> 
			...
			echo '
				...
				<tr><td class=tdsubcabecalho1 align=right width=30%><b> Patrono: </b></td><td class=back><input type=checkbox name=patrono value=1 checked></td></tr>
