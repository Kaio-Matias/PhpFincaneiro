...
// Calculo de ICMS a 12% para atender solicitação do Fred para prover gorduras.	<<<<<
	...
	db_query("UPDATE vendastmp set valorpis = 0.0075*(valorbruto+valordesconto+valoradicional), valorcofins = 0.0075*(valorbruto+valordesconto+valoradicional) where codproduto in ('A00001','A00002','A0001B','A0002B','A10001','A10002')");
...
// Exclusão dos movimentos entre a ILPISA e a EBCI
    ...
    db_query("UPDATE vendastmp SET codtipofatura = 'ZVTF' WHERE codcliente = '200360'");
