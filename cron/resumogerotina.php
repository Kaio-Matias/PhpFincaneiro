...
$sql = "
  SELECT mes, ano, a.codfilial, codgrpcliente, a.codproduto, codsupervisor, codvendedor, quantidade, precomedio
    FROM metavendedor a
	inner join produtos b oN (a.codproduto = b.codproduto and a.codfilial = b.codfilial)
   WHERE mes = '$mes' and ano = '$ano'
ORDER BY a.codfilial, grupo";
