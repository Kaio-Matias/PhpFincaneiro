...
// Calculo de ICMS a 12% para atender solicitação do Fred para prover gorduras.	<<<<<
    ...
    mysql_query("UPDATE vendastmp set codvendedor='421' where documento in ('0092698849')");
...
// Conversão Chocolate - kathiane 30/11/2010
    ...
    db_query("UPDATE vendastmp set quantidade = (quantidade * 12), unidade = 'UN' WHERE unidade = 'CX' AND codproduto in ('D005011','D005012','D005013','D005014','D005021','D005022','D005023')");

    db_query("UPDATE vendastmp set quantidade = (quantidade * 24), unidade = 'UN' WHERE unidade = 'CX' AND codproduto in ('D005001')");
