...
/* Fim */
    ...
    db_query("UPDATE vendastmp set codvendedor='431' where documento in ('93020819')");
	db_query("UPDATE vendastmp set codvendedor='439' where documento in ('93023455','93023499')");
    db_query("UPDATE vendastmp set codvendedor='489' where documento in ('93020136')");

    db_query("UPDATE vendastmp set codvendedor='407' where documento in ('93000102','93000105','93000106','93000131','93000135')");
