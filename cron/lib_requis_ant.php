...
$fd = fopen ($CFG->diretorio.'prod'.$data.'.txt', "r");
	...
	if (!isset($row[0])) {
		...
		id_produto, codigo, descricao, unidade_medida, id_grupo, data_integracao, flag ) VALUES ('','".substr($lala,0,18)."','".substr($lala,18,40)."','".substr($lala,58,3)."','".substr($lala,61,9)."','0000-00-00','I')");
