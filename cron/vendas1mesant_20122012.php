...
/* Fim */
	...
	mysql_query("UPDATE vendastmp set codvendedor='370' where documento in ('92487124','92487113','92487117','92487118','92487140','92487110','92487123','92487143','92487114','92487141','92487122')");
	...
	mysql_query("UPDATE vendastmp set codvendedor='431' where documento in ('93020819')");
	mysql_query("UPDATE vendastmp set codvendedor='439' where documento in ('93023455','93023499')");
	...
	mysql_query("UPDATE vendastmp set codvendedor='407' where documento in ('93000102','93000105','93000106','93000131','93000135')");
...
// Conversão Chocolate - kathiane 30/11/2010
    ...
    db_query("UPDATE vendastmp set quantidade = (quantidade * 12), unidade = 'UN' WHERE unidade = 'CX' AND codproduto in ('D005011','D005012','D005013','D005014','D005021','D005022','D005023','D008002','D008022','D008023','D005025','D005026','D005027','D005028','D005029')");

    db_query("UPDATE vendastmp set quantidade = (quantidade * 24), unidade = 'UN' WHERE unidade = 'CX' AND codproduto in ('D005001','D008001','D005024')");
