...
if(isset($deldesp)){
  ...
  if ($sqlt[0] == '58' || $sqlt[0] == '57' || $sqlt[0] == '56' || $idusuario == '873' || $idusuario == '872' || $idusuario == '874') { //and $idusuario != '873') {
...
if ($act == "impdesp" && $local == '' && $hoje3 >= 20170414 ){
    ...
    if ($vlaut[0] == 0 || $vlaut[0] == NULL ){
     	if ($idusuario == '874' || $idusuario == '12' || $idusuario == '872' || $idusuario == '873' || $idusuario == '874') {
           $hoje2  = substr($dtl,6,4).substr($dtl,3,2).substr($dtl,0,2);
           $ontem = date('Ymd', strtotime('-1 days', strtotime($hoje2)));
           $now  = $dtl;
