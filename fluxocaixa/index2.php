...
if($act == "incdes"){
  ...
  echo "<form action=index2.php name=incdes method=post>";
	echo '
...
if($act == "incbco"){
  $act = '';
  include "../common/data.php";
  echo "<form action=index2.php name=incbco method=post>";
	echo '
	<TABLE class=border cellSpacing=0 cellPadding=0 width=100% align=center border=1>			<TR> 
			<TD> 
				<TABLE cellSpacing=1 cellPadding=2 width=80% border=0>
...
if($act == "inext"){
  $act = '';
  include "../common/data.php";
  echo "<form action=index2.php name=inext method=post>";
	echo '
	<TABLE class=border cellSpacing=0 cellPadding=0 width=100% align=center border=1>			<TR> 
			<TD> 
				<TABLE cellSpacing=1 cellPadding=2 width=80% border=0>
...
if($act == "altext"){
  ...
  $act = '';
  include "../common/data.php";
  echo "<form action=index2.php name=altext method=post>";
	echo '
	<TABLE class=border cellSpacing=0 cellPadding=0 width=100% align=center border=1>			<TR> 
			<TD> 
				<TABLE cellSpacing=1 cellPadding=2 width=80% border=0>
...
if($act == "altprv"){
  ...
  $act = '';
  include "../common/data.php";
  echo "<form action=index2.php name=altprv method=post>";
	echo '
...
if($act == "inprv"){
  $act = '';
  include "../common/data.php";
  echo "<form action=index2.php name=incpre method=post>";
	echo '
	<TABLE class=border cellSpacing=0 cellPadding=0 width=70% align=center border=1>			<TR> 
			<TD> 
				<TABLE cellSpacing=1 cellPadding=2 width=80% border=0>
...
if ($act == "trans") {
  ...
  $autor =  $row4[7];
  include "../common/data.php";
  echo "<form action=index2.php name=autoriza method=post>";
	echo '
	<TABLE class=border cellSpacing=0 cellPadding=0 width=100% align=center border=1>			<TR> 
			<TD> 
				<TABLE cellSpacing=1 cellPadding=2 width=80% border=0>
...
if ($act == "deldesp") {
  ...
  $autor =  $row4[7];
  include "../common/data.php";
  echo "<form action=index2.php name=deldesp method=post>";
	echo '
	<TABLE class=border cellSpacing=0 cellPadding=0 width=100% align=center border=1>			<TR> 
			<TD> 
				<TABLE cellSpacing=1 cellPadding=2 width=80% border=0>
...
if ($act == "pagar") {
  ...
  $autor =  $row4[7];
  include "../common/data.php";
  echo "<form action=index2.php name=pagar method=post>";
	echo '
	<TABLE class=border cellSpacing=0 cellPadding=0 width=100% align=center border=1>			<TR> 
			<TD> 
				<TABLE cellSpacing=1 cellPadding=2 width=80% border=0>
...
<table width="1000" border="1" align="center" cellpadding="0" cellspacing="0">
  <tr class="tdsubcabecalho3">
	<td align="center" bgcolor="#EEDD82 "><font size="3" ><b> E N T R A D A S</b></td><td></TD><td></TD><td></td><td></td><TD align="center" bgcolor="#FFFF00" font size="5" ><b>'.$hoje.'</b></TD>
		<td align="center"><a href="index2.php?act=inext&dtl='.$hoje.'"><img src="images/plus.gif" title="Incluir" border="0"></a>

		<tr class="tdsubcabecalho1">
		  <td  align="center"><b>Bancos/Factorings</b>
		  	<a href="index2.php?act=incbco&dtl='.$hoje.'"><img src="images/plus.gif" title="Incluir Banco" border="0"></a>
		  </td>
		  <td  align="center"><b>Saldo Inicial</b>';
        if ($local == ''){
		   echo'<a href="index2.php?act=saldo&dtl='.$hoje.'"><img src="images/sald_ini.png" title="Atualizar Saldo" border="0"></a></td>';
		}
        echo '
...
if ($numero != 0 && $act == '') {
  while($row = mysql_fetch_row($result)){
		  ...
		  <td align="center">
		  <a href="index2.php?act=altext&codigo=<?=$row[5]?>&banco=<?=$row[0]?>&dtl=<?=$hoje?>"><img src="images/alterar.gif" title="Alterar" border="0"></a>
		  <a href="index2.php?act=delext&codigo=<?=$row[5]?>&dtl=<?=$hoje?>"><img src="images/deletar.gif" title="Deletar" border="0"></a>
...
?>
		...
		<tr class="tdsubcabecalho1">
		  <td  align="center"><b>Previsão de Entrada</b>
		 	<a href="index2.php?act=incgrpp&dtl=<?=$hoje?>"><img src="images/plus.gif" title="Incluir Fomento" border="0"></a>
		  </td>
		  ...
		  <td  align="center"><b>Ação </b><a href="index2.php?act=inprv&dtl=<?=$hoje?>"><img src="images/plus.gif" title="Incluir" border="0"></a></td> </tr>
<?
if ($local != '1006' && $local != '1008'){
...
if ($numero2 != 0 && $act == '') {
	  ...
	  while($row = mysql_fetch_row($result2)){	
		...
		<td align="center"><?=$bco[0]?></td>
		<td align="center">
	    <a href="index2.php?act=altprv&codigo=<?=$row[5]?>&banco=<?=$row[1]?>&dtl=<?=$hoje?>"><img src="images/alterar.gif" title="Alterar" border="0"></a>
		<a href="index2.php?act=delprev&codigo=<?=$row[5]?>&dtl=<?=$hoje?>"><img src="images/deletar.gif" title="Deletar" border="0"></a>
...
//	if ($dtl <= $hhatu){
     	...
     	?>
	     <a href="index2.php?act=impdesp&dtl=<?=$hoje?>"><img src="images/sald_ini.png" title="Atualizar Despesas Até 10:00H" border="0">Autorizações poderão ser excluídas</a></td>
	    <?
//	}
	?>
	 </td><td></td><td></td><td></td><td></td>
     <td align="center"><a href="index2.php?act=incdes&dtl=<?=$hoje?>"><img src="images/plus.gif" title="Incluir Despesa" border="0"></a></td>
		<?
		...
		<tr class="tdsubcabecalho1">
		  <td  align="center"><b>Grupo </b><a href="index2.php?act=incgrpd&dtl=<?=$hoje?>"><img src="images/plus.gif" title="Incluir Grupo Despesas" border="0"></a></td>
    ...
    if ($local == '1006' || $local == '1008'){
       ...
       where venc = $dtl  and centro = '$local' $selecgd order by cc.nome,gg.nome" );
//       where data = $dtl and venc = $dtl and centro = '$local' $selecgd order by cc.nome,gg.nome" );
       ...
       if ($usugrp[0] > 0) {
	      ...
	      inner join $mysql_usu_categ_table as uu ON cc.categoria =  uu.categoria and uu.id = $idusuario
           where venc = $dtl  $selecgd order by cc.nome,gg.nome" );
...
if ($numero3 != 0 && $act == '') {
	  ...
	  while($row = mysql_fetch_row($result3)){	
         ...
         if ($dtj >= $agora){
		  ...
		  <td align="center"><a href="index2.php?act=trans&codigo=<?=$row[8]?>&disp=<?=($tsld - $infbco[1])?>&aautoriz=<?=$infbco[0]?>&dtl=<?=$hoje?>"><img src="images/cima.gif" title="Autorizar" border="0"></a>
		  <td align="center"><a href="pagar2.php?act=pagar&codigop=<?=$row[8]?>&dtl=<?=$hoje?>"><img src="images/final.gif" title="Pagar" border="0"></a>
		  <td align="center"><a href="index2.php?act=altdes&codigo=<?=$row[8]?>&dtl=<?=$hoje?>"><img src="images/alterar.gif" title="Alterar" border="0"></a>
		                     <a href="index2.php?act=deldesp&codigo=<?=$row[8]?>&dtl=<?=$hoje?>"><img src="images/deletar.gif" title="Deletar" border="0"></a>
...
////////////////// JAMES 11042019
	...
	<a href="index2.php?act=incdes&dtl=<?=$hoje?>"><img src="images/plus.gif" title="Incluir" border="0"></a>
		<tr class="tdsubcabecalho1">
		  <td  align="center"><b>Grupo</b><a href="index2.php?act=incgrpd&dtl=<?=$hoje?>"><img src="images/plus.gif" title="Incluir Grupo de Despesas" border="0"></a></td>
		  <td  align="center"><b>Subgrupo</b></td>
		  <td  align="center"><b>Descrição</b></td>
		  <td  align="center"><b>Valor Despesas</b></td>
		  <td  align="center"><b>Valor Autorizado</b></td>
