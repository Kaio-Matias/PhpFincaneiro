...
if(isset($deldesp)){
  ...
  if ($sqlt[0] == '58' || $sqlt[0] == '57' || $sqlt[0] == '56' || $idusuario == '847' || $idusuario == '872' || $idusuario == '874'||  $idusuario == '214') { //and $idusuario != '847') {
...
if ($act == "impdesp" && $local == '' && $hoje3 >= 20170414 ){
    ...
    if ($vlaut[0] == 0 || $vlaut[0] == NULL ){
     	if ($idusuario == '214' || $idusuario == '12' || $idusuario == '872' || $idusuario == '847' || $idusuario == '874'||  $idusuario == '214') {
           $hoje2  = substr($dtl,6,4).substr($dtl,3,2).substr($dtl,0,2);
           $ontem = date('Ymd', strtotime('-1 days', strtotime($hoje2)));
           $now  = $dtl;
