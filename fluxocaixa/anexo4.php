...
if ($doc2_name != "") { 
    $sql = "SELECT processo FROM $mysql_anexo_table WHERE nome = '$doc2_name' AND tipo = 'P'";
    ...
    $sql = "INSERT INTO $mysql_anexo_table VALUES ('NULL','".$id."','".$doc2_name."','".date('Y-m-d',time())."','P')";
	  $result=execsql($sql, $mysql_anexo_table);
			...
			<TR>
			  <TD>
				<TABLE cellSpacing=1 cellPadding=3 width="100%" border=0>
                  ...
                  $sql = "SELECT * FROM $mysql_anexo_table WHERE processo=".$codigop." and tipo = 'P'";
                  @$result=execsql($sql, $mysql_anexo_table);
                  while (@$row=mysql_fetch_row($result)){ echo '
			        <tr>
					  ...
					  <td bgcolor=DDDDDD class=back align=center valign=top width=10%>
                      <a href=anexo4.php?apagar='.$row[0].'&id='.$codigop.'><img border=0 vspace=0 hspace=0 src=images/editdelete.gif></a></td>
                    </tr>';
                  }
...
echo'</TABLE></TD>
           ...
           <form name="doc"  method="post" enctype="multipart/form-data" action="anexo4.php">
