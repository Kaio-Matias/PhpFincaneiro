...
$data2 = substr($data2,6,4).substr($data2,3,2).substr($data2,0,2);
   ...
   <table width="1000" border="1" align="center" cellpadding="0" cellspacing="0">
    <br><br><br><br>
     <tr class="tdsubcabecalho3">
				<TD colspan=100% align=middle><B>Relação de Pagamento</td>
     </tr>	
     <tr class="tdsubcabecalho3">
     ...
     <tr class="tdsubcabecalho3">
		...
		<tr class="tdsubcabecalho2">
          ...
          if ($usugrp[0] > 0) {
            ...
            $result = execsql("select d.codigo, d.codigo2, d.descricao, d.banco, d.val_pg, DATE_FORMAT(d.dtpgto,'%d/%m/%Y') , p.grupo , g.nome from $mysql_pagto_det_table as d
  ...
  while($row = mysql_fetch_row($result)){
		  ...
		  ?>
	      <tr class="tddetalhe">
		  <td align="left"><a href="anexo.php?codigop=<?=$row[0]?>&dtl=<?=$row[5]?>"><?=$nomeg[0]?></a></td>
